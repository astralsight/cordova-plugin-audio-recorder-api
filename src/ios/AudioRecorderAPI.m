...
- (void)record:(CDVInvokedUrlCommand*)command {
  ...
  [self.commandDelegate runInBackground:^{
    ...
    [recordSettings setObject:[NSNumber numberWithFloat:22000.0] forKey: AVSampleRateKey];
    [recordSettings setObject:[NSNumber numberWithInt:1] forKey:AVNumberOfChannelsKey];
    [recordSettings setObject:[NSNumber numberWithInt:64000] forKey:AVEncoderBitRateKey];
